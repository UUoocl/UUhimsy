...
{id = "0", jsn = "OBS_KEY_0", txt = "0", shiftTxt = ")", ind = true, type = true},
...
{id = "Num0", jsn = "OBS_KEY_NUM0", txt = "0", shiftTxt = "Ins", ind = true, type = true},
{id = "Num1", jsn = "OBS_KEY_NUM1", txt = "1", shiftTxt = "End", ind = true, type = true},
{id = "Num2", jsn = "OBS_KEY_NUM2", txt = "2", shiftTxt = "ArrowDown", ind = true, type = true},
{id = "Num3", jsn = "OBS_KEY_NUM3", txt = "3", shiftTxt = "PgDn", ind = true, type = true},
{id = "Num4", jsn = "OBS_KEY_NUM4", txt = "4", shiftTxt = "ArrowLeft", ind = true, type = true},
{id = "Num5", jsn = "OBS_KEY_NUM5", txt = "5", shiftTxt = "5", ind = true, type = false},
{id = "Num6", jsn = "OBS_KEY_NUM6", txt = "6", shiftTxt = "ArrowRight", ind = true, type = true},
{id = "Num7", jsn = "OBS_KEY_NUM7", txt = "7", shiftTxt = "Home", ind = true, type = true},
{id = "Num8", jsn = "OBS_KEY_NUM8", txt = "8", shiftTxt = "ArrowUp", ind = true, type = true},
{id = "Num9", jsn = "OBS_KEY_NUM9", txt = "9", shiftTxt = "PgUp", ind = true, type = true},
}
